...
public class VerificarEmergente extends JFrame {
	...
	public VerificarEmergente() {
		...
		lblNewLabel_1.setIcon(new ImageIcon("C:\\Users\\laval\\Desktop\\Nueva carpeta\\pacman grande2.png"));
		lblNewLabel_1.setBounds(324, 90, 108, 115);
		contentPane.add(lblNewLabel_1);
		
		JLabel lblNewLabel_3 = new JLabel("New label");
		lblNewLabel_3.setIcon(new ImageIcon("C:\\Users\\laval\\Desktop\\Nueva carpeta\\grande2.png"));
		...
		JLabel lblNewLabel_2 = new JLabel(" SOLUCI\u00D3N NO VALIDA");
		lblNewLabel_2.setFont(new Font("Tahoma", Font.BOLD, 13));
		lblNewLabel_2.setForeground(Color.YELLOW);
		lblNewLabel_2.setBounds(143, 58, 155, 45);
		contentPane.add(lblNewLabel_2);
		
		JLabel lblNewLabel_4 = new JLabel("New label");
		lblNewLabel_4.setIcon(new ImageIcon("C:\\Users\\laval\\Desktop\\Nueva carpeta\\linea.png"));
		lblNewLabel_4.setBounds(-12, 214, 309, 19);
		contentPane.add(lblNewLabel_4);
		
		JLabel lblNewLabel_5 = new JLabel("New label");
		lblNewLabel_5.setIcon(new ImageIcon("C:\\Users\\laval\\Desktop\\Nueva carpeta\\linea.png"));
